...
#if defined( _MSC_VER ) && ( defined( M_I86LM ) || defined( M_I86CM ) || defined( M_I86HM ) ) && !defined( MEM_HUGE )
...
#if ( ( defined( __BORLANDC__ ) && ( __BORLANDC__ >= 0x450 ) ) || ( defined( __WATCOMC__ ) && __WATCOMC__ >= 1000 ) || \
      ( defined( __IBMCPP__ ) && __IBMCPP__ >= 250 ) || defined( __hpux ) || defined( __osf__ ) ||                     \
      ( defined( __SUNPRO_CC ) && __SUNPRO_CC >= 0x500 ) || defined( _AIX43 ) )
...
// call with the syntax 'ptr = new (ptr, flags) <type>'
    ...
    inline void MEM_FAR* operator new( size_t new_sz, void MEM_FAR* lpMem, unsigned flags )
    {
...
#if defined( __MWERKS__ ) || defined( __hpux ) || ( defined( __SUNPRO_CC ) && __SUNPRO_CC >= 0x500 )
