...
public:
	enum {	nothing,
					...
					// along before any of them opens. The per-tier gain DIMINISHES (halving each step)
					// until it would drop under 2 percentage points, then holds flat at +2: the ladder
					// runs +62.5 / 68.75 / 71.88 / 73.88 / 75.88 percent of base at levels 4-8. Table in
					...
					// by our buildings goes 80 -> 74 -> 71 percent of base (a diminishing 20 / 26 / 29
					// percent reduction, or 1.25x / 1.35x / 1.41x effective hit points). Same late gating
