...
#define xASSERT_VALID(iPriority,iSection,pObject) ((((iPriority) > __iAssertPriority) || (! ((iSection) & __iAssertSection))) ? (void)0 : ASSERT_VALID (pObject))
#define xASSERT_VALID_OR_NULL(iPriority,iSection,pObject) ((((iPriority) > __iAssertPriority) || (! ((iSection) & __iAssertSection)) || ((pObject) == NULL)) ? (void)0 : ASSERT_VALID (pObject))
